const employees = [
  ...
  { name: "سارة القحطاني", specialization: "دعم فني", cooperation: " نسيان كلمة المرور أو قفل الحساب", contact: "s.qhtani@email.com", extension: "1025" },
  { name: "خالد الشهراني", specialization: "دعم فني", cooperation: " تعطل الطابعة أو مشاكل في الطباعة", contact: "k.shahrani@email.com", extension: "1038" },
  { name: "نورة الغامدي", specialization: "شبكات", cooperation: "حل مشكلات شبكات", contact: "n.gamdi@email.com", extension: "1040" },
  { name: "فهد الحربي", specialization: "شبكات", cooperation: "  توقف التحويلات الهاتفية", contact: "f.harbi@email.com", extension: "1053" },
  { name: "ريم الزهراني", specialization: "موارد بشرية", cooperation: "إدارة ملفات الموظفين", contact: "r.zahrani@email.com", extension: "1066" },
  { name: "عبدالله اليامي", specialization: "موارد بشرية", cooperation: " العلاقات", contact: "a.yami@email.com", extension: "1072" },
  { name: "هيا الشهري", specialization: "موارد بشرية", cooperation: "طلب اجازه ", contact: "h.shahri@email.com", extension: "1081" },
  { name: "لولوة السبيعي", specialization: "إدارة صلاحيات", cooperation: "'طلب صلاحية", contact: "l.sbeai@email.com", extension: "1099" },
  ...
  { name: "رائد الشهري", specialization: "ذكاء اصطناعي", cooperation: " طلب تحديث خوارزمية التصنيف", contact: "r.shahri@email.com", extension: "1132" },
